@include('layouts.header')
	...
	<aside class="main-sidebar elevation-4" style="background-color: #FFFFFF;">
		...
		<center><img src="/images/davis_logo.jpg" style="height: 60px; height: 60px;"></center>
    </a>
    <!-- Sidebar -->
    ...
    <div class="sidebar" style="margin-top: -20px;">
        <!-- Sidebar user panel (optional) -->
        	<div class="user-panel mt-3 pb-3 mb-3 d-flex">
				...
				<img src="/avatars/{{ $user->avatar }}" class="img-circle elevation-2" 
				style="width: 52px; height: 50px;" alt="User Image">
				@else
				<img src="/images/default_avatar.jpg" class="img-circle elevation-2" 
				style="width: 52px; height: 50px;" alt="User Image">
				@endif
			<h5 style="margin-top: 10px;">HI, {{ strtoupper($user->firstname) }}</h5>
		</div>
    </div>
...
@include('dashboard.applicants_table')
